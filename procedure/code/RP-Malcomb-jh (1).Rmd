...
project = readline(prompt="Enter Project Name: ") #Reproducing a Vulnerability Model of Malawi
...
#survey <- read.spss(here("data", "raw", "private", "MWHR61SV", "MWHR61FL.SAV"))
...
survey3 <- read.spss((here("data", "raw", "private", "MWHR61SV", "MWHR61FL.SAV")), to.data.frame = TRUE, stringsAsFactors=FALSE)
#as factors, not numbers
