...
# TRY TO VISUALIZE fig4compare
fig4compare_map = ggplot() +
  geom_sf(data = fig4compare,
          fill = clrs,
          color = NA) +
  geom_stars(data = ta_final) +
  scale_fill_gradient(
...
map_fig5comp = ggplot() +
  ...
  scale_fill_gradient(
    ...
    mid = "CCCCCC",
    high = "#CF4611",
    breaks = c(-0.8176,  0, 0.6141),
    labels = c("Lower Vulnerability", "Mid", "Higher Vulnerability"),
    na.value = "transparent",
    guide = "colourbar",
    limits = c(-0.8176, 0, 0.6141)
  ) +
  scale_x_continuous(breaks = c(33,34,35,36)) +
